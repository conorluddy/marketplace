...
| **x-twitter-scraper** | X/Twitter data and automation through Xquik - search, exports, monitoring, webhooks, MCP, SDKs, and confirmation-gated actions |
...
/plugin install x-twitter-scraper-plugin
